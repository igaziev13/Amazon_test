...
namespace Amazon_test {
    ...
    public partial class myDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string Article, string Name, decimal Price, int Quantity) {
...
namespace Amazon_test.myDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([id] = @Original_id) AND ([Article] = @Origi" +
                "nal_Article) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Article], [Name], [Price], [Quantity]) VALUES (@Ar" +
                "ticle, @Name, @Price, @Quantity);\r\nSELECT id, Article, Name, Price, Quantity FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Article] = @Article, [Name] = @Name, [Price] = @Price, [Quantity] = @Quantity WHERE (([id] = @Original_id) AND ([Article] = @Original_Article) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity));
SELECT id, Article, Name, Price, Quantity FROM Products WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Amazon_test.Properties.Settings.Default.amazon_igConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Article, Name, Price, Quantity FROM dbo.Products";
        ...
        public virtual int Delete(int Original_id, string Original_Article, string Original_Name, decimal Original_Price, int Original_Quantity) {
        ...
        public virtual int Insert(string Article, string Name, decimal Price, int Quantity) {
            if ((Article == null)) {
        ...
        public virtual int Update(string Article, string Name, decimal Price, int Quantity, int Original_id, string Original_Article, string Original_Name, decimal Original_Price, int Original_Quantity, int id) {
            if ((Article == null)) {
                throw new global::System.ArgumentNullException("Article");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Article, string Name, decimal Price, int Quantity, int Original_id, string Original_Article, string Original_Name, decimal Original_Price, int Original_Quantity) {
            return this.Update(Article, Name, Price, Quantity, Original_id, Original_Article, Original_Name, Original_Price, Original_Quantity, Original_id);
        }
    }
